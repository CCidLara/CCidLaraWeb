...
const translations = {
  es: {
    ...
    heroStatement: "Investigando la <em>visión</em> a través de la luz, el aprendizaje profundo, los efectos matemáticos y la fotografía de gran formato.",
  ...
  en: {
    ...
    titleFull: "CHRISTOFER CID LARA",
    titleCompressed: "CCidLara",
    heroStatement: "Investigating <em>vision</em> through light, deep learning, mathematical effects, and large-format photography.",
